...
const CoachWebsiteFinalCTA = ({ themeColor }: Props) => {
  ...
  return (
    <section className="py-16" style={{ background: `linear-gradient(135deg, ${themeColor}15, transparent, ${themeColor}10)` }}>
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-2xl font-extrabold text-foreground sm:text-3xl">Start Your Learning Journey Today</h2>
        <p className="mx-auto mt-3 max-w-lg text-muted-foreground">
          Don't wait — take the first step toward your new career. Join hundreds of successful students.
        </p>

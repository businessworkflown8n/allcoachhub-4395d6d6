...
const blogListJsonLd = {
  ...
  "@type": "Blog",
  name: "AI Coach Portal Blog",
  description: "Learn AI online with expert guides, AI tool reviews, career tips, and the latest artificial intelligence trends. Updated daily.",
...
const AIBlogs = () => {
  ...
  useEffect(() => {
    document.title = "AI Blogs: Learn AI, AI Tools, AI Courses & Career Guide | AI Coach Portal";
    const meta = document.querySelector('meta[name="description"]');
    if (meta) meta.setAttribute("content", "Explore expert AI blogs covering how to learn AI, best AI tools, AI courses, career opportunities, and tips to become an AI coach. Updated daily.");
  }, []);
      ...
      <main className="pt-16">
        ...
        <section className="border-b border-border bg-card/50 py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <h1 className="text-4xl font-bold text-foreground md:text-5xl">AI Blogs, Tools & Career Hub</h1>
        ...
        <div className="container mx-auto px-4 pt-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>AI Blogs</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
